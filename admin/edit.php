                            ...
                            <div class="col-lg-3">
                                <div class="col-md mb-3">
                                    ...
                                    <div class="form-check mt-3">
                                        <input name="status_artikel" class="form-check-input" type="radio" value="publish" id="defaultRadio1" <?= ($data['status_artikel'] == 'publish') ? 'checked' : ''; ?> required>
                                        <label class="form-check-label" for="defaultRadio1"> Publish </label>
                                    </div>
                                    <div class="form-check">
                                        <input name="status_artikel" class="form-check-input" type="radio" value="draft" id="defaultRadio2" <?= ($data['status_artikel'] == 'draft') ? 'checked' : ''; ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php
                                    if ($data['header'] != "") {  ?>
                                        <a href="../files-img/<?= $data['header']; ?>" target="_blank">
                                            <img src="../files-img/<?= $data['header']; ?>" class="img-thumbnail rounded" style="max-width:160px" alt="">
                                        </a>
                                    <?php
                                    } else {
